...
to setup
  ...
  set perimeter-margin      margin-to-perimeter
  set max-street-distance-v max-v-street-distance
  set max-street-distance-h max-h-street-distance
  set min-street-distance-v min-v-street-distance
  set min-street-distance-h min-h-street-distance
  
  set avenues-choice-mode   avenues-how-to-choose
  set -debug-               debug?
